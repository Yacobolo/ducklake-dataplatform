...
platform: workspaces: showcase: {
	kind:            "personal"
	owner_principal: "admin_user"
	folders: analysis: {
		default_project_ref:     "showcase/movielens"
		default_environment_ref: "showcase/movielens/dev"
		notebooks: "01_kpi_walkthrough": {
			description: "Quick KPI checks over curated MovieLens outputs"
			owner:       "admin_user"
			project_ref: "showcase/movielens"
			environment_ref: "showcase/movielens/dev"
			cells: [{
				type: "markdown"
				content: """
				...
				content: """
					...
					FROM lake.main.gold_user_engagement
					GROUP BY region
