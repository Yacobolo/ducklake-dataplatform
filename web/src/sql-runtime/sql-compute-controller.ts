...
function renderLocalError(elements: RuntimeElements, message: string): void {
  renderResultsHTML(
    elements,
    [
      '<div class="rounded-xl border border-[var(--borderColor-danger-muted)] bg-[var(--bgColor-danger-muted)] p-4 shadow-[var(--shadow-resting-xsmall)]">',
...
function renderResultsMessage(elements: RuntimeElements, message: string): void {
  renderResultsHTML(
    elements,
    [
      '<div class="grid place-items-center rounded-xl border border-[var(--borderColor-default)] border-dashed bg-[var(--bgColor-default)] p-4 shadow-[var(--shadow-resting-xsmall)]">',
      '<div class="flex max-w-[var(--overlay-width-small)] flex-col items-center justify-center gap-3 py-8 text-center">',
...
function renderResultTable(elements: RuntimeElements, columns: string[], rows: unknown[][], rowCount: number): void {
  ...
  renderResultsHTML(
    elements,
    [
      '<div class="flex h-full min-h-0 flex-col rounded-xl border border-[var(--borderColor-default)] bg-[var(--bgColor-default)] p-4 shadow-[var(--shadow-resting-xsmall)]">',
