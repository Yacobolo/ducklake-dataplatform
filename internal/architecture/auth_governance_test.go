...
func TestAuthorizationCoverage_CriticalMutatingMethods(t *testing.T) {
	...
	expects := []methodExpectation{
		{file: "internal/service/catalog/catalog.go", method: "CreateSchema", anySnippet: []string{"servicepolicy.CheckSecurablePrivilege("}},
		{file: "internal/service/catalog/catalog.go", method: "UpdateSchema", anySnippet: []string{"servicepolicy.HasAnySecurablePrivilege("}},
		{file: "internal/service/catalog/catalog.go", method: "DeleteSchema", anySnippet: []string{"servicepolicy.HasAnySecurablePrivilege("}},
		{file: "internal/service/catalog/catalog.go", method: "CreateTable", anySnippet: []string{"servicepolicy.CheckSecurablePrivilege("}},
		{file: "internal/service/catalog/catalog.go", method: "DeleteTable", anySnippet: []string{"servicepolicy.HasAnySecurablePrivilege("}},
		{file: "internal/service/catalog/catalog.go", method: "UpdateTable", anySnippet: []string{"servicepolicy.HasAnySecurablePrivilege("}},
		{file: "internal/service/catalog/catalog.go", method: "UpdateColumn", anySnippet: []string{"servicepolicy.HasAnySecurablePrivilege("}},
		{file: "internal/service/catalog/views.go", method: "CreateView", anySnippet: []string{"servicepolicy.CheckSecurablePrivilege(", "servicepolicy.HasAnySecurablePrivilege("}},
		{file: "internal/service/catalog/views.go", method: "DeleteView", anySnippet: []string{"servicepolicy.CheckSecurablePrivilege("}},
		{file: "internal/service/catalog/views.go", method: "UpdateView", anySnippet: []string{"servicepolicy.CheckSecurablePrivilege("}},
		...
		{file: "internal/service/ingestion/ingestion.go", method: "checkInsertPrivilege", anySnippet: []string{"servicepolicy.LookupTableID(", "servicepolicy.CheckSecurablePrivilege("}},
		{file: "internal/service/query/manifest.go", method: "GetManifest", anySnippet: []string{"servicepolicy.CheckSecurablePrivilege("}},
...
func TestAuthorizationMatrix_CriticalPrivilegeAndScopeMapping(t *testing.T) {
	...
	expects := []methodExpectation{
		...
		{file: "internal/service/compute/endpoint.go", method: "requirePrivilege", snippets: []string{"servicepolicy.RequireCatalogPrivilege("}},
		{file: "internal/service/compute/endpoint.go", method: "requireEndpointPrivilege", snippets: []string{"servicepolicy.RequireSecurablePrivilege(", "domain.SecurableComputeEndpoint"}},
