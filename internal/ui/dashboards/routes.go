...
type Routes interface {
	...
	DashboardsSurface(http.ResponseWriter, *http.Request)
	DashboardsUpdatesStream(http.ResponseWriter, *http.Request)
	DashboardsDataStream(http.ResponseWriter, *http.Request)
	DashboardsUpdatesApply(http.ResponseWriter, *http.Request)
	DashboardsTablePageApply(http.ResponseWriter, *http.Request)
...
func MountRoutes(r chi.Router, h Routes) {
	...
	r.Get("/dashboards/{dashboardID}/surface", h.DashboardsSurface)
	r.Get("/dashboards/{dashboardID}/updates/{streamID}", h.DashboardsUpdatesStream)
	r.Get("/dashboards/{dashboardID}/updates/{streamID}/data", h.DashboardsDataStream)
	r.Post("/dashboards/{dashboardID}/updates/{streamID}", h.DashboardsUpdatesApply)
	r.Post("/dashboards/{dashboardID}/updates/{streamID}/table-page", h.DashboardsTablePageApply)
