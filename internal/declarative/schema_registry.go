...
func SchemaDocumentTypes() []SchemaDocumentType {
	return []SchemaDocumentType{
		...
		{Kind: KindNameWorkspace, FileName: "workspace", Type: reflect.TypeOf(WorkspaceDoc{})},
		{Kind: KindNameFolder, FileName: "folder", Type: reflect.TypeOf(FolderDoc{})},
		{Kind: KindNameProject, FileName: "project", Type: reflect.TypeOf(ProjectDoc{})},
		{Kind: KindNameEnvironment, FileName: "environment", Type: reflect.TypeOf(EnvironmentDoc{})},
		{Kind: KindNameDomain, FileName: "domain", Type: reflect.TypeOf(DomainDoc{})},
		{Kind: KindNameTeam, FileName: "team", Type: reflect.TypeOf(TeamDoc{})},
		{Kind: KindNameDataProduct, FileName: "data-product", Type: reflect.TypeOf(DataProductDoc{})},
