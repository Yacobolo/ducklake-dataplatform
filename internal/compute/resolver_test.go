...
func (m *mockPrincipalRepo) GetByID(_ context.Context, _ int64) (*domain.Principal, error) {
	panic("unexpected")
}
...
func (m *mockPrincipalRepo) Delete(_ context.Context, _ int64) error { panic("unexpected") }
...
func (m *mockGroupRepo) GetByID(_ context.Context, _ int64) (*domain.Group, error) {
	panic("unexpected")
}
...
func (m *mockGroupRepo) Delete(_ context.Context, _ int64) error { panic("unexpected") }
...
func (m *mockGroupRepo) ListMembers(_ context.Context, _ int64, _ domain.PageRequest) ([]domain.GroupMember, int64, error) {
	panic("unexpected")
}
func (m *mockGroupRepo) GetGroupsForMember(ctx context.Context, memberType string, memberID int64) ([]domain.Group, error) {
...
func (m *mockComputeRepo) GetByID(ctx context.Context, id int64) (*domain.ComputeEndpoint, error) {
	if m.getByIDFn != nil {
...
func (m *mockComputeRepo) Update(ctx context.Context, id int64, req domain.UpdateComputeEndpointRequest) (*domain.ComputeEndpoint, error) {
	if m.updateFn != nil {
		return m.updateFn(ctx, id, req)
	}
	panic("unexpected")
}
func (m *mockComputeRepo) Delete(ctx context.Context, id int64) error {
	if m.deleteFn != nil {
		return m.deleteFn(ctx, id)
	}
	panic("unexpected")
}
func (m *mockComputeRepo) UpdateStatus(ctx context.Context, id int64, status string) error {
...
func (m *mockComputeRepo) Unassign(ctx context.Context, id int64) error {
	if m.unassignFn != nil {
		return m.unassignFn(ctx, id)
	}
	panic("unexpected")
}
func (m *mockComputeRepo) ListAssignments(ctx context.Context, endpointID int64, page domain.PageRequest) ([]domain.ComputeAssignment, int64, error) {
	if m.listAssignmentsFn != nil {
		return m.listAssignmentsFn(ctx, endpointID, page)
	}
	panic("unexpected")
}
func (m *mockComputeRepo) GetDefaultForPrincipal(ctx context.Context, principalID int64, principalType string) (*domain.ComputeEndpoint, error) {
	if m.getDefaultForPrincipalFn != nil {
		return m.getDefaultForPrincipalFn(ctx, principalID, principalType)
	}
	panic("unexpected")
}
func (m *mockComputeRepo) GetAssignmentsForPrincipal(ctx context.Context, principalID int64, principalType string) ([]domain.ComputeEndpoint, error) {
...
func TestResolver_DirectUserAssignment_Local(t *testing.T) {
	...
	computeRepo := &mockComputeRepo{
		getDefaultForPrincipalFn: func(_ context.Context, principalID int64, principalType string) (*domain.ComputeEndpoint, error) {
	...
	resolver := NewResolver(localExec, computeRepo, principalRepo, &mockGroupRepo{
		getGroupsForMemberFn: func(_ context.Context, _ string, _ int64) ([]domain.Group, error) {
			return nil, nil
		},
	}, nil, nil)
...
func TestResolver_NoAssignment(t *testing.T) {
	...
	computeRepo := &mockComputeRepo{
		getDefaultForPrincipalFn: func(_ context.Context, _ int64, _ string) (*domain.ComputeEndpoint, error) {
			return nil, domain.ErrNotFound("no assignment")
		},
	}
...
func TestResolver_RemoteUnhealthy(t *testing.T) {
	...
	computeRepo := &mockComputeRepo{
		getDefaultForPrincipalFn: func(_ context.Context, _ int64, principalType string) (*domain.ComputeEndpoint, error) {
			if principalType == "user" {
				return &domain.ComputeEndpoint{
