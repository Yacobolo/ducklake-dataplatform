...
var FunctionDocs = map[string]FunctionDoc{
	...
	"add": {
		Signatures: []string{
			"add(col0 DATE, col1 TIME) -> TIMESTAMP",
		},
	...
	"approx_quantile": {
		...
		Signatures: []string{
			"approx_quantile(x SMALLINT, pos FLOAT) -> SMALLINT",
		},
		ReturnType: "SMALLINT",
	},
	"approx_top_k": {
	...
	"arbitrary": {
		Signatures: []string{
			"arbitrary(col0 DECIMAL) -> DECIMAL",
		},
		ReturnType: "DECIMAL",
	},
	"arg_max": {
		...
		Signatures: []string{
			"arg_max(arg TIMESTAMP, val TIMESTAMP WITH TIME ZONE) -> TIMESTAMP",
		},
		ReturnType: "TIMESTAMP",
	},
	"arg_max_null": {
		...
		Signatures: []string{
			"arg_max_null(arg TIMESTAMP WITH TIME ZONE, val DATE) -> TIMESTAMP WITH TIME ZONE",
		},
	...
	"arg_min": {
		...
		Signatures: []string{
			"arg_min(arg DATE, val BIGINT) -> DATE",
		},
		ReturnType: "DATE",
	},
	"arg_min_null": {
		...
		Signatures: []string{
			"arg_min_null(arg TIMESTAMP WITH TIME ZONE, val DATE) -> TIMESTAMP WITH TIME ZONE",
		},
		ReturnType: "TIMESTAMP WITH TIME ZONE",
	},
	"argmax": {
		Description: "Finds the row with the maximum val. Calculates the non-NULL arg expression at that row.",
		Signatures: []string{
			"argmax(arg ANY, val INTEGER) -> ANY",
		},
		ReturnType: "ANY",
	},
	"argmin": {
	...
	"array_distance": {
		...
		Signatures: []string{
			"array_distance(array1 FLOAT[ANY], array2 FLOAT[ANY]) -> FLOAT",
		},
		ReturnType: "FLOAT",
	},
	"array_distinct": {
	...
	"array_extract": {
		Signatures: []string{
			"array_extract(col0 STRUCT, col1 BIGINT) -> ANY",
		},
		ReturnType: "ANY",
	},
	"array_filter": {
	...
	"array_grade_up": {
		...
		Signatures: []string{
			"array_grade_up(list ANY[], col1 VARCHAR, col2 VARCHAR) -> ANY[]",
		},
		ReturnType: "ANY[]",
	},
	"array_has": {
	...
	"array_negative_inner_product": {
		Description: "Compute the negative inner product between two arrays of the same size. The array elements can not be NULL. The arrays can have any size as long as the size is the same for both arguments.",
		Signatures: []string{
			"array_negative_inner_product(array1 FLOAT[ANY], array2 FLOAT[ANY]) -> FLOAT",
		},
		ReturnType: "FLOAT",
	},
	"array_pop_back": {
	...
	"array_sort": {
		...
		Signatures: []string{
			"array_sort(list ANY[], col1 VARCHAR) -> ANY[]",
		},
		ReturnType: "ANY[]",
	},
	"array_to_json": {
	...
	"bit_xor": {
		...
		Signatures: []string{
			"bit_xor(arg USMALLINT) -> USMALLINT",
		},
	...
	"bitstring": {
		...
		Signatures: []string{
			"bitstring(bitstring BIT, length INTEGER) -> BIT",
		},
		ReturnType: "BIT",
	},
	"bitstring_agg": {
	...
	"date_part": {
		...
		Signatures: []string{
			"date_part(ts VARCHAR[], col1 INTERVAL) -> STRUCT()",
		},
		ReturnType: "STRUCT()",
	},
	"date_sub": {
	...
	"datesub": {
		Description: "The number of complete partitions between the timestamps",
		Signatures: []string{
			"datesub(part VARCHAR, startdate TIMESTAMP, enddate TIMESTAMP) -> BIGINT",
		},
		ReturnType: "BIGINT",
	},
	"datetrunc": {
		Description: "Truncate to specified precision",
		Signatures: []string{
			"datetrunc(part VARCHAR, timestamp INTERVAL) -> INTERVAL",
		},
		ReturnType: "INTERVAL",
	},
	"day": {
	...
	"divide": {
		Signatures: []string{
			"divide(col0 UTINYINT, col1 UTINYINT) -> UTINYINT",
		},
		ReturnType: "UTINYINT",
	},
	"duckdb_columns": {
	...
	"epoch_ns": {
		...
		Signatures: []string{
			"epoch_ns(temporal TIME WITH TIME ZONE) -> BIGINT",
		},
		ReturnType: "BIGINT",
	},
	"epoch_us": {
		...
		Signatures: []string{
			"epoch_us(temporal INTERVAL) -> BIGINT",
		},
		ReturnType: "BIGINT",
	},
	"equi_width_bins": {
		...
		Signatures: []string{
			"equi_width_bins(min DOUBLE, max DOUBLE, bin_count BIGINT, nice_rounding BOOLEAN) -> ANY[]",
		},
		ReturnType: "ANY[]",
	},
	"era": {
	...
	"gcd": {
		...
		Signatures: []string{
			"gcd(x HUGEINT, y HUGEINT) -> HUGEINT",
		},
		ReturnType: "HUGEINT",
	},
	"gen_random_uuid": {
	...
	"generate_series": {
		...
		Signatures: []string{
			"generate_series(start BIGINT, stop BIGINT, step BIGINT) -> BIGINT[]",
	...
	"isinf": {
		...
		Signatures: []string{
			"isinf(x TIMESTAMP WITH TIME ZONE) -> BOOLEAN",
		},
		ReturnType: "BOOLEAN",
	},
	"isnan": {
	...
	"json_serialize_plan": {
		Signatures: []string{
			"json_serialize_plan(col0 VARCHAR, col1 BOOLEAN, col2 BOOLEAN) -> JSON",
		},
		ReturnType: "JSON",
	},
	"json_serialize_sql": {
		Signatures: []string{
			"json_serialize_sql(col0 VARCHAR, col1 BOOLEAN) -> JSON",
		},
		ReturnType: "JSON",
	},
	"json_structure": {
	...
	"list_cosine_similarity": {
		...
		Signatures: []string{
			"list_cosine_similarity(list1 DOUBLE[], list2 DOUBLE[]) -> DOUBLE",
		},
		ReturnType: "DOUBLE",
	},
	"list_count": {
	...
	"list_distance": {
		...
		Signatures: []string{
			"list_distance(list1 DOUBLE[], list2 DOUBLE[]) -> DOUBLE",
		},
		ReturnType: "DOUBLE",
	},
	"list_distinct": {
	...
	"list_element": {
		Signatures: []string{
			"list_element(col0 VARCHAR, col1 BIGINT) -> VARCHAR",
		},
		ReturnType: "VARCHAR",
	},
	"list_entropy": {
	...
	"max_by": {
		Description: "Finds the row with the maximum val. Calculates the non-NULL arg expression at that row.",
		Signatures: []string{
			"max_by(arg INTEGER, val HUGEINT) -> INTEGER",
		},
		ReturnType: "INTEGER",
	},
	"md5": {
	...
	"min_by": {
		Description: "Finds the row with the minimum val. Calculates the non-NULL arg expression at that row.",
		Signatures: []string{
			"min_by(arg INTEGER, val INTEGER) -> INTEGER",
		},
		ReturnType: "INTEGER",
	},
	"minute": {
	...
	"mod": {
		Signatures: []string{
			"mod(col0 DECIMAL, col1 DECIMAL) -> DECIMAL",
		},
		ReturnType: "DECIMAL",
	},
	"mode": {
	...
	"monthname": {
		...
		Signatures: []string{
			"monthname(ts TIMESTAMP) -> VARCHAR",
		},
		ReturnType: "VARCHAR",
	},
	"multiply": {
		Signatures: []string{
			"multiply(col0 HUGEINT, col1 HUGEINT) -> HUGEINT",
		},
		ReturnType: "HUGEINT",
	},
	"nanosecond": {
	...
	"parquet_scan": {
		Signatures: []string{
			"parquet_scan(col0 VARCHAR[], hive_types ANY, hive_partitioning BOOLEAN, hive_types_autocast BOOLEAN, encryption_config ANY, schema MAP(INTEGER, union_by_name STRUCT(\"NAME\" VARCHAR, filename \"TYPE\" VARCHAR, compression DEFAULT_VALUE VARCHAR)), debug_use_openssl BOOLEAN, file_row_number ANY, explicit_cardinality VARCHAR, binary_as_string BOOLEAN) -> ",
		},
	},
	"parquet_schema": {
		Signatures: []string{
	...
	"parse_filename": {
		...
		Signatures: []string{
			"parse_filename(string VARCHAR, trim_extension BOOLEAN) -> VARCHAR",
		},
		ReturnType: "VARCHAR",
	},
	"parse_path": {
	...
	"quantile_cont": {
		...
		Signatures: []string{
			"quantile_cont(x DATE, pos DOUBLE) -> DATE",
		},
		ReturnType: "DATE",
	},
	"quantile_disc": {
	...
	"read_json": {
		Signatures: []string{
			"read_json(col0 VARCHAR, convert_strings_to_integers BOOLEAN, maximum_sample_files BIGINT, timestamp_format VARCHAR, field_appearance_threshold DOUBLE, timestampformat VARCHAR, map_inference_threshold BIGINT, date_format VARCHAR, filename ANY, union_by_name BOOLEAN, compression VARCHAR, maximum_depth BIGINT, columns ANY, sample_size BIGINT, hive_types ANY, hive_types_autocast BOOLEAN, maximum_object_size UINTEGER, format VARCHAR, ignore_errors BOOLEAN, hive_partitioning BOOLEAN, auto_detect BOOLEAN, records VARCHAR, dateformat VARCHAR) -> ",
		},
	},
	"read_json_auto": {
		Signatures: []string{
			"read_json_auto(col0 VARCHAR[], convert_strings_to_integers BOOLEAN, maximum_sample_files BIGINT, timestamp_format VARCHAR, field_appearance_threshold DOUBLE, timestampformat VARCHAR, map_inference_threshold BIGINT, date_format VARCHAR, filename ANY, union_by_name BOOLEAN, compression VARCHAR, maximum_depth BIGINT, columns ANY, sample_size BIGINT, hive_types ANY, hive_types_autocast BOOLEAN, maximum_object_size UINTEGER, format VARCHAR, ignore_errors BOOLEAN, hive_partitioning BOOLEAN, auto_detect BOOLEAN, records VARCHAR, dateformat VARCHAR) -> ",
		},
	},
	"read_json_objects": {
		Signatures: []string{
			"read_json_objects(col0 VARCHAR, ignore_errors BOOLEAN, format VARCHAR, maximum_object_size UINTEGER, hive_types_autocast BOOLEAN, hive_types ANY, hive_partitioning BOOLEAN, compression VARCHAR, union_by_name BOOLEAN, filename ANY) -> ",
		},
	},
	"read_json_objects_auto": {
		Signatures: []string{
			"read_json_objects_auto(col0 VARCHAR, ignore_errors BOOLEAN, format VARCHAR, maximum_object_size UINTEGER, hive_types_autocast BOOLEAN, hive_types ANY, hive_partitioning BOOLEAN, compression VARCHAR, union_by_name BOOLEAN, filename ANY) -> ",
		},
	},
	"read_ndjson": {
		Signatures: []string{
			"read_ndjson(col0 VARCHAR, convert_strings_to_integers BOOLEAN, maximum_sample_files BIGINT, timestamp_format VARCHAR, field_appearance_threshold DOUBLE, timestampformat VARCHAR, map_inference_threshold BIGINT, date_format VARCHAR, filename ANY, union_by_name BOOLEAN, compression VARCHAR, maximum_depth BIGINT, columns ANY, sample_size BIGINT, hive_types ANY, hive_types_autocast BOOLEAN, maximum_object_size UINTEGER, format VARCHAR, ignore_errors BOOLEAN, hive_partitioning BOOLEAN, auto_detect BOOLEAN, records VARCHAR, dateformat VARCHAR) -> ",
		},
	},
	"read_ndjson_auto": {
		Signatures: []string{
			"read_ndjson_auto(col0 VARCHAR, convert_strings_to_integers BOOLEAN, maximum_sample_files BIGINT, timestamp_format VARCHAR, field_appearance_threshold DOUBLE, timestampformat VARCHAR, map_inference_threshold BIGINT, date_format VARCHAR, filename ANY, union_by_name BOOLEAN, compression VARCHAR, maximum_depth BIGINT, columns ANY, sample_size BIGINT, hive_types ANY, hive_types_autocast BOOLEAN, maximum_object_size UINTEGER, format VARCHAR, ignore_errors BOOLEAN, hive_partitioning BOOLEAN, auto_detect BOOLEAN, records VARCHAR, dateformat VARCHAR) -> ",
		},
	},
	"read_ndjson_objects": {
		Signatures: []string{
			"read_ndjson_objects(col0 VARCHAR, ignore_errors BOOLEAN, format VARCHAR, maximum_object_size UINTEGER, hive_types_autocast BOOLEAN, hive_types ANY, hive_partitioning BOOLEAN, compression VARCHAR, union_by_name BOOLEAN, filename ANY) -> ",
		},
	},
	"read_parquet": {
		Signatures: []string{
			"read_parquet(col0 VARCHAR[], hive_types ANY, hive_partitioning BOOLEAN, hive_types_autocast BOOLEAN, encryption_config ANY, schema MAP(INTEGER, union_by_name STRUCT(\"NAME\" VARCHAR, filename \"TYPE\" VARCHAR, compression DEFAULT_VALUE VARCHAR)), debug_use_openssl BOOLEAN, file_row_number ANY, explicit_cardinality VARCHAR, binary_as_string BOOLEAN) -> ",
		},
	},
	"read_text": {
		Signatures: []string{
	...
	"regexp_extract": {
		Signatures: []string{
			"regexp_extract(col0 VARCHAR, col1 VARCHAR, col2 INTEGER) -> VARCHAR",
		},
		ReturnType: "VARCHAR",
	},
	"regexp_extract_all": {
		Signatures: []string{
			"regexp_extract_all(col0 VARCHAR, col1 VARCHAR, col2 INTEGER) -> VARCHAR[]",
		},
		ReturnType: "VARCHAR[]",
	},
	"regexp_full_match": {
	...
	"regexp_matches": {
		Signatures: []string{
			"regexp_matches(col0 VARCHAR, col1 VARCHAR, col2 VARCHAR) -> BOOLEAN",
		},
		ReturnType: "BOOLEAN",
	},
	"regexp_replace": {
		Signatures: []string{
			"regexp_replace(col0 VARCHAR, col1 VARCHAR, col2 VARCHAR) -> VARCHAR",
		},
		ReturnType: "VARCHAR",
	},
	...
	"repeat": {
		...
		Signatures: []string{
			"repeat(string ANY[], count BIGINT) -> ANY[]",
	...
	"reservoir_quantile": {
		...
		Signatures: []string{
			"reservoir_quantile(x INTEGER, quantile DOUBLE[]) -> INTEGER[]",
		},
		ReturnType: "INTEGER[]",
	},
	"reverse": {
	...
	"sniff_csv": {
		Signatures: []string{
			"sniff_csv(col0 VARCHAR, hive_types_autocast BOOLEAN, hive_types ANY, union_by_name BOOLEAN, hive_partitioning BOOLEAN, filename ANY, dtypes ANY, column_types ANY, auto_detect BOOLEAN, sample_size BIGINT, dateformat VARCHAR, columns ANY, all_varchar BOOLEAN, new_line VARCHAR, header BOOLEAN, types ANY, skip BIGINT, compression VARCHAR, comment VARCHAR, quote VARCHAR, max_line_size VARCHAR, store_rejects BOOLEAN, delim VARCHAR, sep VARCHAR, column_names VARCHAR[], buffer_size UBIGINT, timestampformat VARCHAR, normalize_names BOOLEAN, ignore_errors BOOLEAN, names VARCHAR[], allow_quoted_nulls BOOLEAN, maximum_line_size VARCHAR, rejects_table VARCHAR, force_not_null VARCHAR[], parallel BOOLEAN, auto_type_candidates ANY, rejects_scan VARCHAR, rejects_limit BIGINT, nullstr ANY, escape VARCHAR, decimal_separator VARCHAR, null_padding BOOLEAN) -> ",
		},
	},
	"split": {
	...
	"str_split_regex": {
		Description: "Splits the string along the regex",
		Signatures: []string{
			"str_split_regex(string VARCHAR, separator VARCHAR, col2 VARCHAR) -> VARCHAR[]",
		},
		ReturnType: "VARCHAR[]",
	},
	"strftime": {
		...
		Signatures: []string{
			"strftime(text VARCHAR, format TIMESTAMP_NS) -> VARCHAR",
		},
		ReturnType: "VARCHAR",
	},
	"string_agg": {
	...
	"time_bucket": {
		...
		Signatures: []string{
			"time_bucket(bucket_width INTERVAL, timestamp DATE, origin INTERVAL) -> DATE",
		},
		ReturnType: "DATE",
	},
	...
	"to_binary": {
		Description: "Converts the value to binary representation",
		Signatures: []string{
			"to_binary(value HUGEINT) -> VARCHAR",
		},
		ReturnType: "VARCHAR",
	},
	"to_centuries": {
