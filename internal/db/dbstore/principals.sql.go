...
const bindExternalID = `-- name: BindExternalID :exec
...
func (q *Queries) BindExternalID(ctx context.Context, arg BindExternalIDParams) error {
	_, err := q.db.ExecContext(ctx, bindExternalID, arg.ExternalID, arg.ExternalIssuer, arg.ID)
	return err
}
