...
function resolveServiceNamespace(context) {
...
function resolveServiceInfo(context, serviceNamespace) {
...
function resolveServiceServers(context, serviceNamespace) {
...
function resolveServiceTags(context, serviceNamespace, endpoints) {
...
function authzMetadataForOperation(operationExtensions) {
